...
- (id)initActiveIndicator{
    ...
    if (self){
        ...
        if (isIPAD) {
            actvity = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(progress.frame.size.width/2-15,35,30,30)];
            ...
            lblWaitPlease= [[UILabel alloc] initWithFrame:CGRectMake(10, 65, 100,40)];
